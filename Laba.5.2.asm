...
.CODE
first_equation_macro macro x_value, is_not_int_output ,numerator_output, denumerator_output
    LOCAL equation_overflow, end_equation
    mov dx, 0

    mov ax, x_value
    mov bx, x_value
    imul bx
    jo equation_overflow
    ...
    mov numerator_output, dx
    mov ax, x_value
    mov denumerator_output, ax
    mov is_not_int_output, 1
    jmp end_equation
    ...
    end_equation:
endm first_equation_macro
second_equation_macro macro x_value, is_not_int_output ,numerator_output, denumerator_output
    LOCAL end_equation
    mov dx, 0
    ...
    mov ax, x
    inc ax
    mov numerator_output, ax 
    sub ax, 2
    neg ax
    mov denumerator_output, ax

    end_equation:
endm second_equation_macro 
third_equation_macro macro x_value
    LOCAL equation_overflow, end_equation
    mov dx, 0
    mov ax, x_value
    mov bx, x_value
...
START:
    ...
    program_loop:
        ...
        first_equation:
            first_equation_macro x, is_not_int, numerator, denumerator
            cmp of_flag, 1
            je is_continue
        ...
        third_equation:
            third_equation_macro x
            cmp of_flag, 1
            je is_continue
            jmp print_result_main
        
        second_equation:
            second_equation_macro x, is_not_int, numerator, denumerator
            jmp print_result_main
